        ...
        if ($validation->fails())
        {
            ...
            if($Setting == null){
                DB::transaction(function()
                {
                    ...
                    if( !$Setting )
                    {
                        return response()->json(['error'=>parent::CurrentLangShow()->Error_Happen]);
                    }
                });
                return response()->json(['success'=> parent::CurrentLangShow()->Edit_successfully,'same_page'=>'1','dashboard'=>'1']);
            }
            else{
                DB::transaction(function()
                {
                ...
                return response()->json(['success'=>parent::CurrentLangShow()->Added_successfully,'same_page'=>'1','dashboard'=>'1']);
            }
        }
    }
