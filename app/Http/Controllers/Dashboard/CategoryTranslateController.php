    ...
    public function post_data(Request $request)
    {
        ...
        if ($validation->fails()) {
            ...
            if ($edit != null) {
                ...
                return response()->json(['success' => __('language.msg.m'), 'dashboard' => '1', 'redirect' => route('dashboard_category.add_edit', ['id' => $CategoryTranslate->category_id])]);
            } else {
                ...
                return response()->json(['success' => __('language.msg.s'), 'dashboard' => '1', 'redirect' => route('dashboard_category.add_edit', ['id' => $CategoryTranslate->category_id])]);
            }
        }
    }
