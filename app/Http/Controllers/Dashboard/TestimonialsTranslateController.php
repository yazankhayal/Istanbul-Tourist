    ...
    public function post_data(Request $request)
    {
        ...
        if ($validation->fails()) {
            ...
            if ($edit != null) {
                ...
                return response()->json(['success' => __('language.msg.m'), 'dashboard' => '1', 'redirect' => route('dashboard_testimonials.add_edit', ['id' => $PostTranslate->testimonials_id])]);
            } else {
                ...
                $PostTranslate->testimonials_id = Input::get('testimonials_id');
                $PostTranslate->save();
                return response()->json(['success' => __('language.msg.s'), 'dashboard' => '1', 'redirect' => route('dashboard_testimonials.add_edit', ['id' => $PostTranslate->testimonials_id])]);
            }
        }
    }
