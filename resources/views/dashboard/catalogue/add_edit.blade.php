...
@section('create_btn'){{route('dashboard_catalogue.index')}}@endsection
                ...
                <div class="m-portlet__body">
                    <div class="form-group m-form__group">
                        <form class="ajaxForm users" enctype="multipart/form-data" data-name="users"
                              action="{{route('dashboard_catalogue.post_data')}}" method="post">
                            {{csrf_field()}}
                            ...
                            <div class="modal-footer">
                                ...
                                <a href="{{route('dashboard_catalogue.index')}}" class="btn btn-default">
                                    {{$lang->Close}}
                                </a>
...
@section('js')
    <script type="text/javascript">
        ...
        var Render_Data = function (id) {
            $.ajax({
                url: "{{route('dashboard_catalogue.get_data_by_id')}}",
                method: "get",
                data: {
                    "id": id,
                },
                ...
                success: function (result) {
                    if (result.success != null) {
                        ...
                        window.location.href = "{{route('dashboard_catalogue.index')}}";
                    }
                }
            });
        };
