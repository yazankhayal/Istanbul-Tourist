                ...
                <div class="m-portlet__body">
                    <div class="form-group m-form__group">
                        <form class="ajaxForm dashboard_scripts" enctype="multipart/form-data" data-name="dashboard_scripts"
                              action="{{route('dashboard_scripts.post_data',app()->getLocale())}}" method="post">
                            {{csrf_field()}}
                            <div class="modal-body">
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group col-md-6 col-6">
                                        ...
                                        <textarea rows="7" placeholder="Custom" class="cls form-control" name="custom" id="custom"></textarea>
                                    </div>
                                </div>
                            </div>
                            <div class="modal-footer">
                                <input type="hidden" name="button_action" id="button_action" value="insert">
                                <a href="{{route('dashboard_scripts.index',app()->getLocale())}}" class="btn btn-default">
                                    {{lang_name_dashbaord('Close')}}
                                </a>
                                <button type="submit" class="btn btn-primary btn-load">
                                    {{lang_name_dashbaord('Submit')}}
                                </button>
                            </div>
                        </form>
                    </div>
...
@section('js')
    ...
    <script type="text/javascript">
        ...
        var Render_Data = function () {
            $.ajax({
                url: "{{ route('dashboard_scripts.get_data_by_id',app()->getLocale()) }}",
                method: "get",
                data: {},
                dataType: "json",
