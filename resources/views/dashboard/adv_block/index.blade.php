                ...
                <div class="m-portlet__body">
                    <div class="form-group m-form__group">
                        <form class="ajaxForm dashboard_adv_block" enctype="multipart/form-data" data-name="dashboard_adv_block"
                              action="{{route('dashboard_adv_block.post_data',app()->getLocale())}}" method="post">
                            {{csrf_field()}}
                            ...
                            <div class="modal-footer">
                                ...
                                <a href="{{route('dashboard_adv_block.index',app()->getLocale())}}" class="btn btn-default">
...
@section('js')
    ...
    <script type="text/javascript">
        ...
        var Render_Data = function () {
            $.ajax({
                url: "{{ route('dashboard_adv_block.get_data_by_id',app()->getLocale()) }}",
                method: "get",
                data: {},
                dataType: "json",
