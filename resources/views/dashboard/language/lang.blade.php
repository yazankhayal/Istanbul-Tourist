                                                ...
                                                <div class="col-12" id="r_h_{{$key}}">
                                                    <div class="form-group">
                                                        <div class="row">
                                                            ...
                                                            <div class="col-md-1">
                                                                <button type="button" class="d-none btn_remove_h btn btn-danger btn-sm" data-id="{{$key}}">
                                                ...
                                                <div class="col-12" id="r_d_{{$key}}">
                                                    <div class="form-group">
                                                        <div class="row">
                                                            ...
                                                            <div class="col-md-1">
                                                                <button type="button" class="btn d-none btn_remove_d btn-danger btn-sm" data-id="{{$key}}">
                                                                    <i class="fa fa-trash"></i>
                                                                </button>
                                                            </div>
                                                        </div>
    ...
    <script>
        $(document).ready(function(){
            ...
            $(document).on('click', '.btn_remove_h', function(){
                ...
                $('#r_h_'+button_id+'').remove();
            });

            $(document).on('click', '.btn_remove_d', function(){
                var button_id = $(this).data("id");
                $('#r_d_'+button_id+'').remove();
            });
